...
<nav class="navbar navbar-expand-lg navbar-light bg-light navCol">
  ...
  <button type="button" class="btn btn-outline-primary "> <a id="icol" href="../logOut.php">Logout</a></button>
        ...
        <div class="butadd">
    <a href="addDeb.php"><button type="button" class="btn btn-outline-secondary">Add Department</button></a>  
    </div>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" width="24%">department Name</th>
      <th scope="col" width="24%">department Sup Name</th>
