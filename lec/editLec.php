...
$id= $_GET['id'];
    ...
    $sql2 = "UPDATE `lecture_lab` SET `ID_lec_lab`=$idd ,`lec_lab_name`='$nameLec' ,`lec_lab_sub_name`='$supNameLec' ,`Id_stf`=$IdStf ,`name_stf`='$nameStf' ,`lec_lab_corse`= $corseLec ,`id_dep`=$id_dep ,`stageLec`=$stageLec  WHERE ID_lec_lab=$idd";
