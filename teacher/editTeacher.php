...
if (isset($_POST['fname'])){
    ...
    $sql2 = "UPDATE `staff` SET `ID_stf`=$idd,`stf_first_name`='$fname',`stf_last_name`='$lname',`stf_email`='$email',`stf_user_name`='$userName',`stf_password`='$password',`stf_scientific_title`='$title',`stf_functional_class`='$class',`dep_id`=$dep_id,`unv_id`=$unv_id WHERE `ID_stf`=$idd";
