...
<div class="butadd">
    <a href="addTeacher.php"><button type="button" class="btn btn-outline-secondary">Add Teacher</button></a>  
    </div>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" >Scientific Title</th>
      <th scope="col" >functional Class</th>
