...
<div class="butadd">
    <a href="addLec.php"><button type="button" class="btn btn-outline-secondary">Add Lecture</button></a>  
    </div>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" >Lecture Sup Name</th>
      <th scope="col" >Teacher Name</th>
      <th scope="col" >Lecture corse</th>
...
<tbody>
    <tr>
    <td><?php echo $i;?></td>
                    <td><?php echo $sdata['lec_lab_name']?></td>
                    <td><?php echo $sdata['lec_lab_sub_name']?></td>
                    <td><?php echo $sdata['name_stf']?></td>
                    <td><?php echo $sdata['lec_lab_corse']?></td>
                    <td><?php echo $sdata['stageLec']?></td>
                    <td>
                        <a  href="editLec.php?id=<?php echo $sdata['ID_lec_lab'];?>">Edit</a>&nbsp&nbsp|&nbsp&nbsp
                        <a  href="deleteLec.php?id=<?php echo $sdata['ID_lec_lab'];?>">Delete</a>
                    </td>
    </tr>
