...
if (isset($_POST['fname'])){
    ...
    $sql = "INSERT INTO `student`(`stu_first_name`, `stu_last_name`, `stu_email`, `stu_user_name`, `stu_password`, `stu_age`, `stu_address`, `stu_stage`, `stu_status`, `corse`, `dep_id`)
    VALUES('$fname','$lname','$email','$userName','$password','$age','$address',$stage,$statuss,$corse,$dep_id)";
